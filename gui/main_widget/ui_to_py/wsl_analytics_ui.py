...
"}")
        ...
        self.BreakTypePoint = QtWidgets.QRadioButton(self.formLayoutWidget)
        self.BreakTypePoint.setObjectName("BreakTypePoint")
        self.horizontalLayout.addWidget(self.BreakTypePoint)
        ...
        self.BreakTypeReef = QtWidgets.QRadioButton(self.formLayoutWidget)
        self.BreakTypeReef.setObjectName("BreakTypeReef")
        self.horizontalLayout_3.addWidget(self.BreakTypeReef)
        self.BreakTypeRiver = QtWidgets.QRadioButton(self.formLayoutWidget)
        self.BreakTypeRiver.setObjectName("BreakTypeRiver")
        self.horizontalLayout_3.addWidget(self.BreakTypeRiver)
        ...
        self.BreakTypeEng = QtWidgets.QRadioButton(self.formLayoutWidget)
        self.BreakTypeEng.setObjectName("BreakTypeEng")
        self.BreakForm.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.BreakTypeEng)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_2.setText(_translate("MainWindow", "Beach        "))
        self.BreakTypePoint.setText(_translate("MainWindow", "Point"))
        self.BreakCountryLabel.setText(_translate("MainWindow", "Country:"))
        self.BreakTypeReef.setText(_translate("MainWindow", "Reef          "))
        self.BreakTypeRiver.setText(_translate("MainWindow", "River"))
        self.BreakTypeEng.setText(_translate("MainWindow", "Engineered"))
