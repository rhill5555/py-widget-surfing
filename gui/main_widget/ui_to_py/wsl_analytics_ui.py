...
"}")
        ...
        self.BioFirTourCb = QtWidgets.QComboBox(self.formLayoutWidget_2)
        self.BioFirTourCb.setStyleSheet("background: #fcf4ff")
        self.BioFirTourCb.setObjectName("BioFirTourCb")
        self.BioLeftForm.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.BioFirTourCb)
        ...
        self.BioAddlocbutton.setGeometry(QtCore.QRect(630, 260, 150, 40))
        ...
        self.BioAddimagebut.setGeometry(QtCore.QRect(630, 330, 150, 40))
