...
"}")
        ...
        self.comboBox.setStyleSheet("background: #fcf4ff")
        ...
        self.lineEdit_4.setStyleSheet("background: #fcf4ff")
        ...
        self.lineEdit_5.setStyleSheet("background: #fcf4ff")
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_5)
        self.BioAddlocbutton_2 = QtWidgets.QPushButton(self.breakschedtab)
        self.BioAddlocbutton_2.setGeometry(QtCore.QRect(450, 220, 150, 40))
        self.BioAddlocbutton_2.setStyleSheet("background: #dcb3ff;")
        self.BioAddlocbutton_2.setObjectName("BioAddlocbutton_2")
        ...
        self.MaleBox_2 = QtWidgets.QCheckBox(self.verticalLayoutWidget_3)
        self.MaleBox_2.setObjectName("MaleBox_2")
        self.verticalLayout_2.addWidget(self.MaleBox_2)
        self.FemaleBox_2 = QtWidgets.QCheckBox(self.verticalLayoutWidget_3)
        self.FemaleBox_2.setObjectName("FemaleBox_2")
        self.verticalLayout_2.addWidget(self.FemaleBox_2)
        self.BioSubmitBut_2 = QtWidgets.QPushButton(self.breakschedtab)
        self.BioSubmitBut_2.setGeometry(QtCore.QRect(110, 430, 150, 40))
        self.BioSubmitBut_2.setStyleSheet("background: #ff93ac;")
        self.BioSubmitBut_2.setObjectName("BioSubmitBut_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Season:"))
        self.label_5.setText(_translate("MainWindow", "Break:"))
        self.label_6.setText(_translate("MainWindow", "Name:"))
        self.label_7.setText(_translate("MainWindow", "Stop #:"))
        self.label_8.setText(_translate("MainWindow", "Open Date:"))
        self.label_9.setText(_translate("MainWindow", "Close Date:"))
        self.BioAddlocbutton_2.setText(_translate("MainWindow", "Add Location"))
        self.MaleBox_2.setText(_translate("MainWindow", "Male"))
        self.FemaleBox_2.setText(_translate("MainWindow", "Female"))
        self.BioSubmitBut_2.setText(_translate("MainWindow", "Submit"))
